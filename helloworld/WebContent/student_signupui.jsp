...
<body>
  <a href="http://www.lnmiit.ac.in/"> <img src="logo.png" title="lnmiit" height="100" /></a>
	...
	<form class="login" action="student_signup.jsp" method="post" >
		<h1>Student SignUp</h1>
	    <input type="text" name="name" class="login-input" placeholder="Full_Name" autofocus>
	    <input type="text" name="rollno" class="login-input" placeholder="Roll_No." autofocus>
	    <input type="text" name="emailid" class="login-input" placeholder="email_id" autofocus>
