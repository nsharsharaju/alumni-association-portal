...
<form class="login" action="alumniupdate.jsp" method="get" >
		<h1>Update Your Details</h1>
<p>	    <h3>Detail You want to update</h3>
  ...
  <option value="research">Research</option>
	    ...
	    <input type="text" name="vsa" class="login-input" placeholder="Enter your updated detail" autofocus>
